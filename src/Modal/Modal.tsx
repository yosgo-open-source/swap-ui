...
const useStyles = makeStyles((theme: Theme) => ({
  root: {
    display: "flex",
    alignItems: ({ fullWidth }: styleProps) =>
      fullWidth ? "flex-end" : "center",
  ...
  icon: {
    ...
    color: ({ iconColor, checkIconColor }: styleProps) =>
      iconColor === "primary50"
  ...
  footer: {
    height: "100%",
    padding: ({ label, secondaryButton, primaryButton, mobile }: styleProps) =>
    ...
    display: "flex",
    flexDirection: ({ mobile }: styleProps) => (mobile ? "column" : "row"),
    alignItems: "center",
    justifyContent: "space-between",
  },
  footerButton: {
    width: ({ buttonFullWidth, footerDisplayColumn, mobile }: styleProps) =>
      buttonFullWidth || footerDisplayColumn || mobile ? "100%" : null,
    display: "flex",
    flexDirection: ({ footerDisplayColumn }: styleProps) =>
      footerDisplayColumn ? "column-reverse" : "row",
    alignItems: "center",
  },
}));
